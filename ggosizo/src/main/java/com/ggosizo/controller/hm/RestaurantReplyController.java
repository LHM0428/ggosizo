...
import com.ggosizo.service.hm.RestaurantReplyService;

@RestController
@RequestMapping("/restaurantReplies")
public class RestaurantReplyController {

	@Inject
	private RestaurantReplyService service;
	
	@RequestMapping(value="", method=RequestMethod.POST)
	public ResponseEntity<String> register(@RequestBody RestaurantReplyVO vo){
	...
	public ResponseEntity<List<RestaurantReplyVO>> list(@PathVariable("no")int no){
		
		ResponseEntity<List<RestaurantReplyVO>> entity = null;
		try {
			entity = new ResponseEntity<List<RestaurantReplyVO>>(service.list(no), HttpStatus.OK);
		} catch (Exception e) {
			e.printStackTrace();
			entity = new ResponseEntity<List<RestaurantReplyVO>>(HttpStatus.BAD_REQUEST);
		}
		return entity;
	}
	...
	public ResponseEntity<String> update(@PathVariable("reply_no") int reply_no,
			@RequestBody RestaurantReplyVO vo){
	...
	public ResponseEntity<Map<String, Object>> listPage(
		...
		try {
			...
			List<RestaurantReplyVO> list = service.listReplyPage(no, cri);
