...
import com.ggosizo.service.yj.NoticeReplyService;
...
public class NoticeReplyController {
	...
	public ResponseEntity<List<NoticeReplyVO>> list(@PathVariable("no")int no){
	...
	public ResponseEntity<Map<String, Object>> listPage(
		...
		try {
			...
			List<NoticeReplyVO> list = service.listReplyPage(no, cri);
			map.put("list", list);
