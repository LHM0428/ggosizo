...
import com.ggosizo.service.yj.EventReplyService;
...
public class EventReplyController {
	...
	public ResponseEntity<String> register(@RequestBody EventReplyVO vo){
	...
	public ResponseEntity<List<EventReplyVO>> list(@PathVariable("no")int no){
		
		ResponseEntity<List<EventReplyVO>> entity = null;
		try {
	...
	public ResponseEntity<Map<String, Object>> listPage(
		...
		try {
			...
			List<EventReplyVO> list = service.listReplyPage(no, cri);
			map.put("list", list);
