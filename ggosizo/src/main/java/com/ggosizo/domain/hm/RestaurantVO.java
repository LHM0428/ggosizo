...
public class RestaurantVO extends DateCourse{
	
	public RestaurantVO() {
		// TODO Auto-generated constructor stub
	}

	public RestaurantVO(int no, String name, String addr, String si, String gugun, String dong, String coming,
			String tel, String url, String img, String openhour, String closeday, String startdate, String enddate,
			String category, String price, String content, String writer, int viewcnt, int replycnt, int likecnt,
			Date regdate, String file) {
	...
	public String toString() {
		return "RestaurantVO [toString()=" + super.toString() + ", getNo()=" + getNo() + ", getName()=" + getName()
